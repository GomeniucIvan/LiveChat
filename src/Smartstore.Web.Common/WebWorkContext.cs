...
namespace Smartstore.Web
{
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private CustomerWebContextDto _customerWebContextDto;
        ...
        {
            get => _customer != null && _language != null;
        }
        ...
        public CustomerWebContextDto CurrentCustomerById(int customerId)
        {
            if (_customerWebContextDto != null && _customerWebContextDto.Id != customerId)
            {
                return _customerWebContextDto;
            }

            _customerWebContextDto = _db.Customer_WebContext(customerId);
            return _customerWebContextDto;
        }
